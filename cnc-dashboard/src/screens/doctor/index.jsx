    ...
    <Header />
        ...
        <div className="overflow-x-auto rounded-lg border border-gray-200 shadow-md m-5">
           <div className="w-full flex flex-row mb-4 ">
                <h1 className="font-medium  md:text-2xl ml-6 mt-4">All Doctors</h1>
                <Link to="/doctor/add-doctor" className="ml-auto rounded-md bg-black px-3.5 py-1.5 font-semibold leading-7 text-white hover:bg-black/80 mr-6 mt-4">Add Doctors</Link>
            </div>
